...
Since all the BibTeX entries are represented by rows in a `tibble`, all entries can be altered just like one would alter the value of a certain cell in a `tibble`. 
